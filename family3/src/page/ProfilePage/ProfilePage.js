...
export default class ProfilePage extends Component {
    ...
    render() {
        ...
        // iterates through JSON object
        // and populates a JSON array
...
                        buttonStyle = {{width: 100}}
                ...
                <View style = {styles.avatarContainer}>
                {/* if google account, display google profile pic
                otherwise if virtual account, display empty profile pic */}
                <Avatar
                size="xlarge"
                rounded
                ...
                <View style = {styles.contentContainer}>
                    ...
                    <Text style = {{color: '#ffffff', alignSelf: 'center'}}> {this.state.googleUserData.user.givenName} {this.state.googleUserData.user.familyName}</Text>
                    </View> 
                    <Text>{"\n"}</Text>
                    <View style = {styles.profileInfo}>
                    <Text style = {{color: '#ffffff', alignSelf: 'center'}}>{this.state.googleUserData.user.email}</Text>
                    </View>
                </View>
